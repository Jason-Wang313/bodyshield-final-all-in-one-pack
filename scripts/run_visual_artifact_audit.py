"""Run visual artifact integrity checks for generated figures and GIF media."""
...
from bodyshield.visual_artifact_audit import failed_visual_artifact_rows, visual_artifact_summary, write_visual_artifact_reports
...
def main(argv: list[str] | None = None) -> int:
    ...
    rows = write_visual_artifact_reports(args.root)
    ...
    if args.json:
        ...
        print(f"VISUAL_ARTIFACT_STATUS={status}")
