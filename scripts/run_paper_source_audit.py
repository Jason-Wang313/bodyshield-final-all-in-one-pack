"""Run paper-source integrity checks for the BodyShield non-hardware pack."""
...
from bodyshield.paper_source_audit import failed_paper_source_rows, paper_source_summary, write_paper_source_audit_reports
...
def main(argv: list[str] | None = None) -> int:
    ...
    rows = write_paper_source_audit_reports(args.root)
    ...
    if args.json:
        ...
        print(f"PAPER_SOURCE_STATUS={status}")
