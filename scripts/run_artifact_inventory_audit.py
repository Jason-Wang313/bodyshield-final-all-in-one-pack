"""Run artifact inventory checks for the BodyShield non-hardware pack."""
...
from bodyshield.artifact_inventory_audit import (
    ...
    write_artifact_inventory_audit_reports,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    rows = write_artifact_inventory_audit_reports(args.root)
    ...
    if args.json:
        ...
        print(f"ARTIFACT_INVENTORY_STATUS={status}")
