"""Run claim-boundary checks for the BodyShield non-hardware pack."""
...
from bodyshield.claim_boundary_audit import claim_boundary_summary, failed_claim_boundary_rows, write_claim_boundary_reports
...
def main(argv: list[str] | None = None) -> int:
    ...
    rows = write_claim_boundary_reports(args.root)
    ...
    if args.json:
        ...
        print(f"CLAIM_BOUNDARY_STATUS={status}")
