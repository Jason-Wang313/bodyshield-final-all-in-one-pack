...
| RELEASE_BUNDLE_MANIFEST.csv                 | extracted_payload_file_count_matches_pack_inspection | pass     | extracted verifier file count matches pack-side release inspection                                                  | 252                                                | 252               |
| RELEASE_BUNDLE_MANIFEST.csv                 | extracted_payload_bytes_match_pack_inspection        | pass     | extracted verifier payload bytes match pack-side release inspection                                                 | 368879578                                          | 368879578         |
| RELEASE_BUNDLE_MANIFEST.csv                 | zip_entry_count_matches_manifest_plus_control_files  | pass     | zip entries equal payload manifest rows plus release README and release manifest                                    | 254                                                | 254               |
