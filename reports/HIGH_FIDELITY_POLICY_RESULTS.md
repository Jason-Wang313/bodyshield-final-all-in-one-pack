...
The repository contains bounded high-fidelity/contact probes in at least these engines or settings: `mujoco, mujoco_planar`. These probes are useful stress evidence, but they are not a full external trained-policy benchmark and do not close the hardware evidence tier.
