...
| artifact_manifest | pass | rows=312; code_version=212b65210a58a1ce; hashes and required rows match |
...
| release_bundle | pass | payload_files=473; zip_bytes=15341205; zip_sha256=b8cf762e35662e0f9b9de0c703a3db5581a5be4e623587f0e20e9c737776161c |
| evidence_consistency | pass | rows=599; documents=7; all referenced local evidence exists |
...
| results_integrity_audit | pass | checks=353; artifacts=64; generated tables pass integrity checks |
| source_import_audit | pass | checks=295; artifacts=241; source compile/import and hardware-stub safety pass |
...
| stale_phrases | pass | no stale downgrade phrases in 309 text files |
