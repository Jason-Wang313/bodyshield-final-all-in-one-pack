...
|---|---:|
| audited documents | 7 |
| references checked | 681 |
| passing references | 681 |
...
| README_EXECUTION.md | scripts/run_claim_boundary_audit.py                   | ok       | file exists and is nonempty |         1 |
| README_EXECUTION.md | scripts/run_command_surface_audit.py                  | ok       | file exists and is nonempty |         1 |
| README_EXECUTION.md | scripts/run_config_schema_audit.py                    | ok       | file exists and is nonempty |         1 |
| README_EXECUTION.md | scripts/run_derived_results_audit.py                  | ok       | file exists and is nonempty |         1 |
| README_EXECUTION.md | scripts/run_environment_dependency_audit.py           | ok       | file exists and is nonempty |         1 |
| README_EXECUTION.md | scripts/run_results_integrity_audit.py                | ok       | file exists and is nonempty |         1 |
| README_EXECUTION.md | scripts/run_source_import_audit.py                    | ok       | file exists and is nonempty |         1 |
| README_EXECUTION.md | scripts/run_paper_source_audit.py                     | ok       | file exists and is nonempty |         1 |
